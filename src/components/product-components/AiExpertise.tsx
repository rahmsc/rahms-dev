          ...
          >
            <div className="flex flex-col items-center space-y-6 sm:space-y-8">
              ...
              <div className="text-center space-y-2 sm:space-y-3">
                <h3 className="text-xl sm:text-2xl font-bold text-white tracking-wide font-body">
                  Daniel Milad
                </h3>
              ...
              >
                ...
                <span className="font-medium text-sm group-hover:translate-x-0.5 transition-transform duration-300 font-body">
                  Connect on LinkedIn
                </span>
              </a>
            </div>
